...
const editableGroups = [
  ...
  {
    title: "سؤال‌ها و معرفی",
    fields: [
      ["positioningLabel", "برچسب بخش سؤال‌ها"],
      ["positioningTitle", "عنوان بخش سؤال‌ها"],
      ["positioningBody", "متن بخش سؤال‌ها"],
  ...
  },
  {
    ...
    fields: [
      ...
      ["workOneDescription", "توضیح مجموعه اول"],
      ["workOneBody", "متن آیتم اول"],
      ["workTwoYear", "زمان آیتم دوم"],
      ["workTwoTitle", "عنوان آیتم دوم"],
      ["workTwoDescription", "توضیح مجموعه دوم"],
      ["workTwoBody", "متن آیتم دوم"],
      ["workThreeYear", "زمان آیتم سوم"],
      ["workThreeTitle", "عنوان آیتم سوم"],
      ["workThreeDescription", "توضیح مجموعه سوم"],
      ["workThreeBody", "متن آیتم سوم"],
      ["workFourYear", "زمان آیتم چهارم"],
      ["workFourTitle", "عنوان آیتم چهارم"],
      ["workFourDescription", "توضیح مجموعه چهارم"],
      ["workFourBody", "متن آیتم چهارم"],
      ["workFiveYear", "زمان آیتم پنجم"],
      ["workFiveTitle", "عنوان آیتم پنجم"],
      ["workFiveDescription", "توضیح مجموعه پنجم"],
